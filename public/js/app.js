...
var update = __webpack_require__(10)("42daffda", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(10)("21e970b4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(10)("546e0e5f", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(10)("7e8276f8", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(10)("2347ef7a", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
        ...
        isEdit: function isEdit() {
            ...
            if (this.editField) {
                ...
                if (this.editField.type === 'checkbox') {
                    var options = this.editField.options.replace(/"/g, '');
      ...
      _c("div", { staticClass: "field" }, [
        ...
        _c("div", { staticClass: "control" }, [
          _c("input", {
            directives: [
              {
                name: "model",
                rawName: "v-model",
                value: _vm.form.dutch_name,
                expression: "form.dutch_name"
              }
            ],
            staticClass: "input",
            attrs: {
            ...
            domProps: { value: _vm.form.dutch_name },
            on: {
              input: function($event) {
                if ($event.target.composing) {
                  return
                }
                _vm.$set(_vm.form, "dutch_name", $event.target.value)
              }
            }
          })
        ])
        ...
        _c("div", { staticClass: "control" }, [
          _c(
            "button",
            {
              ...
              attrs: { type: "submit", formaction: _vm.isEdit }
            },
            [_vm._v("\n                " + _vm._s(this.btn) + "\n            ")]
          )
        ])
