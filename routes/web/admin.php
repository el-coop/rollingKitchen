...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'userType:' . \App\Models\Admin::class], 'namespace' => 'Admin'], function () {
    ...
    Route::group(['prefix' => 'filesystem'], function () {
        Route::patch('/order', 'PDFController@saveOrder');
    ...
    Route::group(['prefix' => 'shifts'], function () {
        ...
        Route::post('/duplicate/{shift}', 'ShiftController@duplicate');
    });
    ...
    Route::group(['prefix' => 'bands'], function () {
        ...
        Route::get('/pdf/{bandPdf}', 'BandController@showPdf');
...
Route::group(['prefix' => 'admin/kitchens/applications/{application}/products/menu', 'middleware' => ['auth', 'userType:' . \App\Models\Admin::class], 'namespace' => 'Kitchen'], function () {
    Route::get('/', 'ApplicationProductController@create');
    Route::post('/', 'ApplicationProductController@store');
    Route::get('/{product}', 'ApplicationProductController@edit');
    ...
    Route::delete('/{product}/photo/{productPhoto}', 'ApplicationProductController@destroyPhoto');
});
