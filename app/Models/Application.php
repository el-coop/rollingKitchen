...
class Application extends Model {
    ...
    public function getMenuTableAttribute() {
        return [
            'model' => Product::class,
            'where' => [['application_id', $this->id], ['category', '!=', 'other']],
            'joins' => [
            ...
            'fields' => [
                [
                    ...
                    'name' => 'name',
                    'title' => __('admin/applications.product'),
                    'sortField' => 'name',
                ],
                [
                    'name' => 'price',
                    'title' => __('admin/applications.price'),
            ...
            (
                SELECT JSON_ARRAYAGG(
                    JSON_OBJECT(
                        ...
                        'file', pp.file,
                        'url', CONCAT('/images/product_photos/', pp.id)
                    )
                )
