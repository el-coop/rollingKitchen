...
class BackupEmail extends Mailable {
	...
	public function build() {
		return $this->usingBackupSmtp()->from(env('BACKUP_MAIL_FROM'))->subject(env('APP_NAME') . ' backup for ' . Carbon::now()->toDateString())->view('mail.raw')->with('body', 'Backup for ' . Carbon::now()->toDateString() . ' is attached')
