				...
				<div class="table-container">
					<vuetable ref="table"
						...
						<template :v-if="deleteSlot" #delete="props">
							<datatable-delete-form :delete-btn="deleteBtn || $translations.delete" :action="deleteAction + props.rowData.id"
...
<script>
	import Vuetable from 'vue3-vuetable/src/components/Vuetable.vue';
	import VuetablePaginationInfo from 'vue3-vuetable/src/components/VuetablePaginationInfo.vue';
