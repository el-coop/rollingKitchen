...
class BandPaymentServiceTest extends TestCase {
	...
	protected function setUp(): void {
		...
		$this->bands = factory(Band::class,4)->create()->each(function ($band) use ($stage){
		...
		$i = -1;
		$this->bandPaymentsColumns = factory(BandPaymentExportColumn::class, 2)->make()->each(function ($column) use ($columns,$i){
			$i = $i + 1;
