...
use App\Notifications\Kitchen\UserCreated;
...
class CreateTest extends TestCase {
    ...
    public function test_admin_can_store_artist_manager(){
        ...
        $kitchen = User::where(['email' => 'a@a.com', 'user_type' => Kitchen::class])->first()->user;
        $this->assertDatabaseHas('kitchens', [
            'id' => $kitchen->id
        ]);
        Notification::assertSentTo($kitchen->user, UserCreated::class);
