...
namespace Admin\Kitchens\Kitchens;
...
class ApplicationTest extends TestCase {
	...
	protected function setUp(): void {
		...
		Field::factory(5)->create(['form' => Application::class]);
		$this->applications = collect();
		$this->kitchens = Kitchen::factory(5)->create([
			'data' => function () {
			...
			for ($i = 0; $i < 2; $i++) {
				$kitchen->applications()->save(Application::factory()->make(['year' => 2016 + $i]));
			}
		});
