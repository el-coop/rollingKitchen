...
namespace Admin\Kitchens\Settings;
...
class FileSystemTest extends TestCase {
    ...
    public function test_admin_can_upload_pdf() {
        ...
        $this->actingAs($this->admin->user)->post(action('Admin\PDFController@upload'), [
            ...
            'terms_and_conditions_nl' => true,
            'terms_and_conditions_en' => true,
        ])->assertSuccessful();
        ...
        $this->assertTrue($pdf->terms_and_conditions_en);
        $this->assertTrue($pdf->terms_and_conditions_nl);
