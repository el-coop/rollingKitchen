...
class SupervisorTest extends TestCase {
	...
	public function test_guest_cant_get_shift() {
		$this->get(action('Worker\SupervisorController@editShift', [$this->workplace, $this->shift]))->assertRedirect(action('Auth\LoginController@login'));
	}
	...
	public function test_worker_cant_get_shift() {
		$this->actingAs($this->worker)->get(action('Worker\SupervisorController@editShift', [$this->workplace, $this->shift]))->assertForbidden();
	}
	...
	public function test_guest_cant_close_shift() {
		$this->patch(action('Worker\SupervisorController@closeShift', [$this->workplace, $this->shift]))->assertRedirect(action('Auth\LoginController@login'));
	}
	
	public function test_kitchen_cant_close_shift() {
		$this->actingAs($this->kitchen)->patch(action('Worker\SupervisorController@closeShift', [$this->workplace, $this->shift]))->assertForbidden();
	}
	
	public function test_admin_cant_close_shift() {
		$this->actingAs($this->admin)->patch(action('Worker\SupervisorController@closeShift', [$this->workplace, $this->shift]))->assertForbidden();
	}
	
	public function test_worker_cant_close_shift() {
		$this->actingAs($this->worker)->patch(action('Worker\SupervisorController@closeShift', [$this->workplace, $this->shift]))->assertForbidden();
	}
	
	public function test_supervisor_can_close_shift() {
		$this->actingAs($this->supervisor)->patch(action('Worker\SupervisorController@closeShift', [$this->workplace, $this->shift]))->assertSuccessful();
	...
	public function test_supervisor_cant_close_closed_shift() {
		...
		$this->shift->save();
		$this->actingAs($this->supervisor)->patch(action('Worker\SupervisorController@closeShift', [$this->workplace, $this->shift]))->assertForbidden();
	}
	...
	public function test_admin_cant_remove_worker_from_shift() {
